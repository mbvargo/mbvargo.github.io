...
**Third, reductions to crime are modest**. At around 3-7% annually, the effect is modest — as reasonably expected. There is no silver bullet that can stop crime from occurring, and we should instead think about the cumulative effect of these interventions over time. Combined with other interventions, GI can help make communities safer. 
